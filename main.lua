...
-- No `index` field on new moves. The `index` field is only used by GenSave.lua
-- when converting original ROM cartridge saves, not by the recomp's own save
-- format (which stores moves by string id). Animation lookup also uses string
-- id via the battle_anims registry, not this field. Omitting it skips the
-- 0..255 schema constraint entirely (the field is marked optional).
local newMoves = {
